...
export const EDITOR_SCHEMA = [
  ...
  section('humidity', '💧', 'Поточна вологість', [
    ...
    num('cur_offset_y', 'Положення по вертикалі Y', -200, 200, 6, 1),
  ...
  section('target', '🎯', 'Панель цільової вологості', [
    ...
    num('hum_panel_bottom', 'Положення по вертикалі Y', -100, 500, 50, 1),
  ...
  section('buttons', '🔘', 'Нижні кнопки', [
    ...
    num('btns_bottom', 'Положення блоку по вертикалі Y', -100, 300, -13, 1),
