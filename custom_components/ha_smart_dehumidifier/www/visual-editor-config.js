...
export const EDITOR_SCHEMA = [
  ...
  section('layout', '📐', 'Розкладка', [
    ...
    num('content_padding_top', 'Відступ зверху', 0, 200, 0, 1),
    num('content_padding_bottom', 'Відступ знизу', 0, 200, 0, 1),
    num('content_padding_left', 'Відступ ліворуч', 0, 400, 10, 1),
    num('content_padding_right', 'Відступ праворуч', 0, 400, 10, 1),
    num('device_offset_x', 'Зсув приладу по X', -200, 200, 0, 1),
    num('device_offset_y', 'Зсув приладу по Y', -200, 200, 0, 1),
    num('controls_max_width', 'Макс. ширина нижніх блоків', 80, 900, 500, 1),
  ]),
  ...
  section('arc', '🔵', 'Дуга та повзунок', [
    ...
    num('arc_radius', 'Радіус дуги', 100, 500, 150, 1),
    num('arc_bg_width', 'Товщина фону', 1, 120, 20, 1),
    num('arc_cur_width', 'Товщина поточної', 1, 120, 20, 1),
    num('arc_tgt_width', 'Товщина цілі', 1, 120, 20, 1),
    tog('arc_glow', 'Світіння дуги', true),
    // Поля з колишньої вкладки dot
    num('dot_radius', 'Радіус повзунка', 3, 80, 18, 1),
    num('dot_hit_radius', 'Зона дотику повзунка', 6, 120, 20, 1),
  ...
  section('auto_ui', '🪄', 'Автовологість', [
    ...
    num('auto_ui_popup_y', 'Auto панель — позиція Y', -200, 400, -85, 1),
    num('auto_ui_popup_width', 'Auto панель — ширина', 60, 320, 150, 1),
    num('auto_ui_popup_height', 'Auto панель — висота', 20, 120, 25, 1),
  ...
  section('humidity', '💧', 'Поточна вологість', [
    ...
    num('cur_size', 'Розмір цілої', 10, 220, 140, 1),
    num('cur_dec_size', 'Розмір десяткової', 10, 160, 100, 1),
    num('cur_unit_size', 'Розмір %', 8, 160, 70, 1),
    ...
    num('cur_offset_y', 'Положення по вертикалі Y', -200, 200, 22, 1),
  ...
  section('target', '🎯', 'Панель цільової вологості', [
    ...
    num('hum_panel_width', 'Ширина панелі (%)', 120, 520, 250, 1),
    num('hum_panel_max_width', 'Макс. ширина панелі (px)', 120, 600, 320, 10),
    num('hum_panel_height', 'Висота панелі', 40, 220, 70, 1),
    num('hum_panel_radius', 'Заокруглення панелі', 0, 100, 35, 1),
    ...
    num('hum_btn_size', 'Діаметр кнопок ±', 20, 160, 60, 1),
    num('hum_btn_font_size', 'Розмір іконок ±', 8, 64, 35, 1),
    num('hum_panel_bottom', 'Положення по вертикалі Y', -100, 500, 40, 1),
    // Кольори tgt_color видалено
  ]),

  section('buttons', '🔘', 'Нижні кнопки', [
    tog('show_btns', 'Показати кнопки', true),
    num('btn_height', 'Висота кнопок', 20, 120, 70, 1),
    num('btn_icon_size', 'Розмір іконок', 8, 60, 30, 1),
    num('btn_label_size', 'Розмір підписів', 6, 30, 16, 1),
  ...
  section('effects', '✨', 'Візуальні ефекти', [
    ...
    num('efx_fan_size', 'Розмір вентилятора', 50, 600, 400, 10),
    num('efx_fan_opacity', 'Прозорість вентилятора (%)', 0, 100, 10, 1),
    num('efx_fan_speed', 'Швидкість вентилятора (1-100)', 1, 100, 70, 1),
    tog('efx_comet_show', 'Увімкнути комету (орбіту)', false),
    num('efx_comet_size', 'Розмір орбіти', 50, 600, 350, 10),
    num('efx_comet_speed', 'Швидкість комети (1-100)', 1, 100, 83, 1),
    tog('efx_core_show', 'Увімкнути пульсуюче ядро', false),
    num('efx_core_size', 'Розмір ядра', 50, 500, 200, 10),
    num('efx_core_speed', 'Швидкість пульсації (1-100)', 1, 100, 74, 1),
    tog('efx_part_show', 'Увімкнути частинки', false),
    num('efx_part_count', 'Кількість частинок', 5, 100, 55, 1),
    num('efx_part_spread', 'Радіус розлітання частинок', 50, 600, 400, 10),
    num('efx_part_speed', 'Швидкість частинок (1-100)', 1, 100, 86, 1),
    num('efx_offset_y', 'Положення по вертикалі Y', -200, 200, 13, 1),
  ]),
];