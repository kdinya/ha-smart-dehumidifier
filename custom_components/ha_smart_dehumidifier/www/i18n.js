// Мова картки/редактора. За замовчуванням - англійська (поки в
// конфігу картки не задано language - тобто щойно встановлена картка).
// Увесь наявний текст у коді написаний українською, тож переклад
// працює як "словник заміни": ключ - оригінальний український рядок,
// значення - його англійський відповідник. Це дозволяє додати мову
// БЕЗ переписування самих компонентів (settings-panel.js,
// visual-editor-config.js) під систему i18n-ключів - рядки лишаються
// як є, змінюється лише те, що показується.
...
// Глобальна подія (window), якою спливаюче вікно шестерні (settings-panel.js)
// сповіщає про зміну мови - щоб візуальний редактор (dehumidifier-editor.js),
// який є ОКРЕМИМ елементом з власним _config (а не тим самим інстансом
// картки), теж міг миттєво перемалюватися новою мовою в усіх вкладках,
