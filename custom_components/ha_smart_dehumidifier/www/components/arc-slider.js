...
function getArcConfig(config = {}) {
  return {
    ...
    arc_radius: config.arc_radius !== undefined ? config.arc_radius : 150,
    ...
    arc_bg_width: config.arc_bg_width !== undefined ? config.arc_bg_width : 20,
    arc_cur_width: config.arc_cur_width !== undefined ? config.arc_cur_width : 20,
    arc_tgt_width: config.arc_tgt_width !== undefined ? config.arc_tgt_width : 20,
    arc_glow: config.arc_glow !== undefined ? config.arc_glow : true,
    dot_radius: config.dot_radius !== undefined ? config.dot_radius : 18,
    dot_hit_radius: config.dot_hit_radius !== undefined ? config.dot_hit_radius : 20,
