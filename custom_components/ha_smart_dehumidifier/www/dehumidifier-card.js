  ...
  static styles = css`
    ...
    .dh-frame-aspect {
      /* aspect-ratio дає "бажану" (максимальну, незатиснуту) форму й
         ...
         За замовчуванням форма - --dh-frame-ar (та самого приладу,
         майже квадрат), а НЕ --dh-glass-ar (1.7) - без цього на вузьких
         екранах (телефон портрет) вся картка примусово розтягується в широкий
         плаский прямокутник, навіть коли місця обмало. "Скляна" широка
         пропорція (--dh-glass-ar) вмикається нижче лише на широких екранах
         (>=480px) - там, де це дійсно дає єфект "леттербоксу" замість
         розтягування. */
      width: 100%;
