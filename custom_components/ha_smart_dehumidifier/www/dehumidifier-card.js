  ...
  static styles = css`
    ...
    .dh-device {
      ...
      /* Єдина, безбрейкпоінтна формула "вписати найбільший прямокутник
         ...
         урахуванням форми пристрою (95cqb * --dh-frame-ar-num - тут 95%
         лишається навмисно: невеликий запас зверху/знизу для дуги), і
         ...
         квадратна. Раніше тут теж було 95cqi - коли картка вужча за
         "Макс. ширину ПРИЛАДУ" (типовий портретний телефон), ці 5%
         лишались порожнім простором з одного боку (бо вирівнювання за
         замовчуванням - "left", а не "center") - пристрій виглядав
         зсунутим ліворуч, а не на всю ширину картки. */
      width: min(100cqi, calc(95cqb * var(--dh-frame-ar-num, 1)), var(--dh-frame-max-width, 400px));
      aspect-ratio: var(--dh-frame-ar, 1);
